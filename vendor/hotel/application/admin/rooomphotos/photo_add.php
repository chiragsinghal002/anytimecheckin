    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          ...
          <span>Your image size should be (262 × 169 pixels)</span>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open_multipart(base_url('admin/roomphotos/add'), 'class="form-horizontal"');  ?> 
            
             <div class="form-group">
                <label for="role" class="col-sm-2 control-label">Hotel Name</label>

                <div class="col-sm-9">
                  <select name="hotel_id" class="form-control" id="hotel_id" onchange="room_type(this.value)" >
