  ...
  <section class="sidebar">
      ...
      <ul class="sidebar-menu">
       <li id="users" class="treeview">
            ...
            <ul class="treeview-menu">
              <li id="add_user"><a href="<?= base_url('admin/booking/livebooking'); ?>"><i class="fa fa-angle-double-right"></i> Live Booking </a></li>

              <li id="add_user"><a href="<?= base_url('admin/users/assignrole'); ?>"><i class="fa fa-angle-double-right"></i>Offline Booking</a></li> 
     ...
     <ul class="sidebar-menu">
       ...
       <li id="adminlte1" class="treeview">
        ...
        <li id="charts" class="treeview">
         ...
         <!--  <ul class="treeview-menu">      -->   
          ...
          <a href="<?= base_url('admin/roomfacilities'); ?>">
            ...
            <li id="flot"><a href="<?= base_url('admin/rooms'); ?>"><i class="fa fa-angle-double-right"></i> Add/Views Room </a></li>
        ...
        <li id="ui" class="treeview">
          ...
          <!-- <ul class="treeview-menu"> -->
             <li class="new-act"><a href="<?= base_url('admin/discount'); ?>"><i class="fa fa-angle-double-right"></i>Add/Views Campaning </a></li>

            <li class="new-act"><a href="<?= base_url('admin/discount/campingdate'); ?>"><i class="fa fa-angle-double-right"></i>Add/Views Campaning Date </a></li>
      ...
      ?>
        ...
        <li id="users1" class="treeview1">
          <a href="<?= base_url('admin/usermodule'); ?>">
            <i class="fa fa-dashboard"></i> <span>Add/Views User Module</span>
            <span class="pull-right-container">
              <i class="fa fa-angle-left pull-right"></i>
            </span>
          </a>           
          ...
          <li id="users" class="treeview">
            ...
            <!-- <li id="add_user"><a href="<?= base_url('admin/usermodule/'); ?>"><i class="fa fa-angle-double-right"></i> User List </a></li> -->          
             ...
             <!--  <li id="add_user"><a href="<?= base_url('admin/users/assignrole'); ?>"><i class="fa fa-angle-double-right"></i>Add/Views Assign User Role </a></li> -->              
              <li id="view_users" class=""><a href="<?= base_url('admin/users'); ?>"><i class="fa fa-angle-double-right"></i>Add/Views Assign User </a></li>
            <!-- </ul> -->
          </li> 
          <?php } ?>         
    ...
    if ($this->session->userdata('role')!=1) {
      ?>
              ...
              <li id="add_user"><a href="<?= base_url('admin/booking'); ?>"><i class="fa fa-angle-double-right"></i> Live Booking </a></li>

              <li id="add_user"><a href="<?= base_url('admin/users/assignrole'); ?>"><i class="fa fa-angle-double-right"></i>Offline Booking</a></li> 
            <?php } else{
              ?>
              <li id="add_user"><a href="<?= base_url('admin/booking/livebookings'); ?>"><i class="fa fa-angle-double-right"></i> Live Booking </a></li>
