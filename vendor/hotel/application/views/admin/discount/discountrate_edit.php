<section class="content">
  <div class="row">
    ...
    if ($this->session->userdata('role')!=1 AND $this->session->userdata('role')!=2) {
      ?>
                  <select  name="hotel_id" class="form-control" readonly>
                    
                    <!-- <option value="">Select Hotel</option> -->
                    <?php foreach($all_hotels as $row): ?>

                    <option class="act"  value="<?= $row['hotel_id']; ?>" <?= ($disrate['hotel_id'] == $row['hotel_id'])?'selected': '' ?> ><?= $row['hotel_name']; ?></option>
                      <?php endforeach; ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select  name="room_type_id" class="form-control" readonly>
                    
                   <!--  <option value="">Select Room Type</option> -->
                    <?php foreach($room_types as $room_type): ?>

                    <option class="act" value="<?= $room_type['room_type_id']; ?>" <?= ($disrate['room_type_id'] == $room_type['room_type_id'])?'selected': '' ?> ><?= $room_type['hotel_room_type']; ?></option>
                      <?php endforeach; ?>
...
?>
 <div id="ifHourly" style="display: show;">
    <label for="max_hour">Max. Hour</label>
     <!-- <input type="text"  name="max_hour"  value="6" disabled /> -->
     <select name="max_hour" class="form-control" disabled>
    ...
    <label for="min_hour">Min. Hour</label>
     ...
     <select name="min_hour" class="form-control">
                    ...
                    <option value="1" <?= ($disrate['min_hour'] == 1)?'selected': '' ?> >1</option>
                    <option value="2" <?= ($disrate['min_hour'] == 2)?'selected': '' ?>>2</option>
                    <option value="3" <?= ($disrate['min_hour'] == 3)?'selected': '' ?> >3</option>
                    <option value="4" <?= ($disrate['min_hour'] == 4)?'selected': '' ?>>4</option>
                    <option value="5" <?= ($disrate['min_hour'] == 5)?'selected': '' ?> >5</option>
                    <!-- <option value="6" <?= ($disrate['min_hour'] == 6)?'selected': '' ?>>6</option> -->
                  </select>

    <!--  <input type="text" name="min_hour" value="<?php echo $disrate['min_hour'];?>" /> -->
     <br />
</div>
            <br>
<div id="ifDaily" style="display: none;">
    <label for="max_day">Max. Day</label>
     <input type="text" name="max_day" value="6" />
     <br />
    <label for="min_day">Min. Day</label>
     <input type="text" name="min_day" /><br />
</div>
<?php } ?>
<?php 
...
<div id="ifDaily" style="display: show;">
    <label for="max_day">Max. Day</label> 
    <!-- <input type="text" name="max_day" value="6" disabled /> -->
    <select name="max_day" class="form-control">
      <option value="6">6</option>
    </select>
    <br />

    <label for="min_day">Min. Day</label> 
    <!-- <input type="text" name="min_day" value="<?php echo $disrate['min_day'];?>" /> -->
     <select name="min_day" class="form-control">
                    <!-- <option value="">Select Status</option> -->
                    <option value="1" <?= ($disrate['min_day'] == 1)?'selected': '' ?> >1</option>
                    <option value="2" <?= ($disrate['min_day'] == 2)?'selected': '' ?>>2</option>
                    <option value="3" <?= ($disrate['min_day'] == 3)?'selected': '' ?> >3</option>
                    <option value="4" <?= ($disrate['min_day'] == 4)?'selected': '' ?>>4</option>
                    <option value="5" <?= ($disrate['min_day'] == 5)?'selected': '' ?> >5</option>
                    <!-- <option value="6" <?= ($disrate['min_hour'] == 6)?'selected': '' ?>>6</option> -->
                  </select>
    <br />
</div>
<br>
 <div id="ifHourly" style="display: none;">
   <!--  <label for="max_hour">Max. Hour</label> -->
     <label for="min_hour">Max. Hour</label><input type="text"  name="max_hour" value="6" disabled />
     <br />
