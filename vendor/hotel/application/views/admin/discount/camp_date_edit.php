    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Edit Campaign Date</h3>
           <div class="tt">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open(base_url('admin/discount/editcampdate/'.$campdate['camp_date_id']), 'class="form-horizontal needs-validation" novalidate' )?>
    ...
    if ($this->session->userdata('role')!=1 AND $this->session->userdata('role')!=2) {
      ?>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="camp_id" id="validationCustom100" required class="form-control">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="from_date" value="<?= $campdate['from_date']; ?>" class="form-control" id="from_date validationCustom100" required placeholder="">
				  <div class="invalid-feedback">
              Enter From Date
            </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="to_date" value="<?= $campdate['to_date']; ?>" class="form-control" id="to_date validationCustom100" required placeholder="">
				  <div class="invalid-feedback">
				  Enter To Date
                </div>
              </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="camp_date_status" id="validationCustom100" required class="form-control">
