      ...
      <div class="box">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open_multipart(base_url('admin/roomfacilities/edit/'.$ad['facility_id']), 'class="form-horizontal needs-validation" novalidate' )?> 
              ...
              <div class="form-group">
                <label for="email validationCustom101" class="col-sm-2 control-label">Status</label>

                <div class="col-sm-9">
                 <select name="status" id="status validationCustom100" required class="form-control">
