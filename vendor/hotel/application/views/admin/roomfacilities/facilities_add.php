      ...
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Add Room Facility</h3>
           <div class="tt">
            <a href="<?= base_url('admin/roomfacilities'); ?>" class="btn btn-info btn-flat"><< Back</a>
           </div>
        </div>
        <!-- /.box-header -->
        <!-- form start -->
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open_multipart(base_url('admin/roomfacilities/add'), 'class="form-horizontal needs-validation" novalidate');  ?> 
              <div class="form-group">
                <label for="ad_name validationCustom01" class="col-sm-2 control-label">Facility Title</label>

                <div class="col-sm-9">
                  <input type="text" name="facility_name" class="form-control" id="ad_name validationCustom01" required  placeholder="">
...
<!-- 
              <div class="form-group">
                ...
                <div class="col-sm-9 gallery">
                  <input type="file" name="image[]" multiple="multiple" id="inputFile1 validationCustom01" required class="form-control" accept="image/*">
				  			  				        <div class="invalid-feedback">
        Enter Image
      </div>
                </div>
