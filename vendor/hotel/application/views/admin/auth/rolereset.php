        ...
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-4 text-center">
                <div class="login-title">
                    <h3><!--<span>Anytimecheckin</span>-->Forgot Password</h3>
...
// echo $string;
                ...
                <div class="form-box">
                    ...
                    <?php echo form_open(base_url('admin/auth/rolereset'), 'class="login-form" '); ?>
                        ...
                        <div class="col-md-12 manager"><a href="<?php echo base_url('admin/auth/role')?>" class="form-control">Login</a></div>    
...
.add-area {
    background: #ffffff url(https://anytimecheckin.com/new/vendor/image/signup-back.jpg) no-repeat;
