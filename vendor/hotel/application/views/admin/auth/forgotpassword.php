...
// echo $string;
                ...
                <div class="form-box">
                    ...
                    <?php echo form_open(base_url('admin/auth/forgot'), 'class="login-form" '); ?>
                        ...
                        <div class="col-md-12 manager"><a href="<?php echo base_url('admin/auth/login')?>" class="form-control">Login</a></div>    
