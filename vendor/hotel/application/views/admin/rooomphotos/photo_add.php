      ...
      <div class="box">
        ...
        Enter Hotel Name
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  ...
                  <select name="room_id" required class="form-control validationCustom02" id="sel_city">
        ...
        Enter Room Type
             ...
             <div class="form-group">
                ...
                <label for="to_date validationCustom03" class="col-sm-2 control-label">Image</label>



                <div class="col-sm-9">

                  <input type="file" name="userfile[]" multiple="multiple" id="validationCustom03" required class="form-control" accept="image/*">
