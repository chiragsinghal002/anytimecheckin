...
<link rel="stylesheet" href="//code.jquery.com/ui/1.12.1/themes/base/jquery-ui.css">
  ...
  $( function() {
    ...
    <div class="box-body table-responsive"> 
        <form method="get" class="grid-none"  action="<?= base_url('admin/booking/'); ?>">
           
            
            <input type="text" name="indate" id="indate" value="<?php if(!empty($_GET['indate'])){ echo $_GET['indate']; } ?>" placeholder="from" required="required"/>

             <input type="text" name="outdate" id="outdate" value="<?php if(!empty($_GET['outdate'])){ echo $_GET['outdate']; } ?>" placeholder="to" required="required"/>
             <select name="booking_type" required="required">
             	<option value="">Booking Type</option>
             	<option value="1" <?php if(!empty($_GET['booking_type'])=='1'){ ?>selected="selected"<?php } ?>>Day</option>
             	<option value="2" <?php if(!empty($_GET['booking_type'])=='2'){ ?>selected="selected"<?php } ?>>Hour</option>
             </select>
          ...
          <tr>
           ...
           $check_out_time =  date("h:i a",strtotime($originaltime1));
            ...
            <td><?= $check_out_time ; ?></td>
             ...
             <td><?= ($row['booking_type']==1)?'Day':'Hour'; ?></td>
