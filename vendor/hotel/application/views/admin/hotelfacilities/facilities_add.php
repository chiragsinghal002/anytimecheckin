    ...
    <div class="col-md-12">
      <div class="box">
        ...
        Enter Facilityname
              ...
              <!-- <div class="form-group">
                <label for="to_date validationCustom02" class="col-sm-2 control-label">Image</label>

                <div class="col-sm-9 gallery">
                  <input type="file" name="image[]" multiple="multiple" id="inputFile1 validationCustom02" required class="form-control" accept="image/*">
				  			        <div class="invalid-feedback">
        Please upload image
      </div>
                </div>
