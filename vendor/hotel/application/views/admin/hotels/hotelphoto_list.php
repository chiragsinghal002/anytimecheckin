...
<div class="box-header">
    ...
    if ($this->session->userdata('role')!=1 AND $this->session->userdata('role')!=2) {
      ?>
         ...
         <div class="tt"><a href="<?= base_url('admin/hotels/addhotelphotos'); ?>" class="btn btn-info btn-flat">Add Hotel Photos</a></div>
         <?php } ?>
...
<td class="text-left"><a href="<?= base_url('admin/hotels/addhotelphotos'); ?>" class="btn btn-info " >Add Hotel Photos</a></td>
    ...
    <div class="box-body table-responsive">
        <!-- <form method="get" action="<?= base_url('admin/hotels/hotelphoto_list/'); ?>">
         ...
         <a href="<?= base_url('admin/hotels/hotelphoto_list/'); ?>">Reset</a> -->
    ...
    if ($this->session->userdata('role')!=1 AND $this->session->userdata('role')!=2) {
      ?>
              <a href="<?= base_url('admin/hotels/delhotelphoto/'.$row['hotel_photo_id']); ?>" class="btn btn-danger btn-flat " onclick="return confirm_alert(this);">Delete</a>
              <?php } ?>
