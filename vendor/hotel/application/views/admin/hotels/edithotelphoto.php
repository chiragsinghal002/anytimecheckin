    ...
    if ($this->session->userdata('role')!=1 AND $this->session->userdata('role')!=2) {
      ?>
             ...
             <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="file" name="userfile[]" multiple="multiple" id="validationCustom101" required class="form-control" accept="image/*">
        ...
        ?>    
              ...
              <div class="form-group">
                <label for="role validationCustom102" class="col-sm-2 control-label">Status</label>

                <div class="col-sm-9">
                  <select name="status" class="form-control" id="validationCustom102" required>
