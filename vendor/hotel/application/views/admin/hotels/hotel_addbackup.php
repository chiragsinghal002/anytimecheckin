...
<section class="content">
        ...
        <div class="form-group">
          ...
          <!-- end test dropdown -->
             ...
             <!--  <div class="form-group">
              ...
              <div class="form-group">
                <label for="fax validationCustom08" class="col-sm-2 control-label">Fax No</label>
              ...
              <div class="form-group">
                <label for="airport validationCustom09" class="col-sm-2 control-label">Nearest Airport</label>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="file" name="hotel[]" id="validationCustom11" class="form-control" required accept="image/*">
                  <div class="invalid-feedback">
                    Enter Image
                  </div>
                </div>
  ...
  <div class="form-group">
    ...
    <div class="col-sm-9">
      <input type="text"  class="controls" id="google_search" placeholder="Enter Destination.." name="search" required=""> 
      <div id="map"></div>
