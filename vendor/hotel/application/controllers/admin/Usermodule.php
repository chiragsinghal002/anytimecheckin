<?php
	...
	class Usermodule extends MY_Controller {
		...
		public function index(){
			 ...
			 {
			     	$data['all_users'] =  $this->usermodule_model->get_all_users($_GET,$id);
			 }
			 else
			 {
			     	$data['all_users'] =  $this->usermodule_model->get_all_users($search='',$id);
			 }
		...
		public function add(){
			...
			if($this->input->post('submit')){
				...
				$email = $_POST['email'];				
				$data['user email'] =  $this->usermodule_model->get_user_by_email($email);
				...
				if ($this->form_validation->run() == FALSE) {
					...
					if ($data['user email']['user_email']!=$_POST['email']) {
						//echo "kanchan";die;
				...
				redirect(base_url('admin/usermodule/add'));
