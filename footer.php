        ...
        <div class="footer-content">
          ...
          <div class="col-sm-10 col-md-10">
            ...
            <div class="information">
              ...
              <ul>
                ...
                <li><a href="page.php?id=4">About Us</a></li>

                <li><a href="page.php?id=8">Blog</a></li>
                
                <li><a href="vendor/hotel/admin/">Vendor Login</a></li>
                 <li><a href="all_top_hotels.php">Top Hotels</a></li>
                 <li><a href="page.php?id=9">Terms & Cancellation </a></li>
          ...
          <div class="col-sm-2 col-md-2">
           ...
           <div class="money-cards">
                <ul>
                    <li><a href="#"><img src="image/visa-any.png" /></a></li>
                    <li><a href="#"><img src="image/master-any.png" /></a></li>
                </ul>
            </div>
        ...
        <div class="row">
          ...
          <div class="col-sm-12 col-md-12">
            ...
            <div class="copy" align="center">
              ...
              <p>Copyright © 2018 by Anytime Check In</p>
...
<script src="js/footer-common.js"></script>