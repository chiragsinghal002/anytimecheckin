...
<div class="item active">
		<div class="row">
				...
				<div class="col-md-6">
					<a class="thumbnail" href="http://anytimecheckin.com/new/image/an-add2.jpg"><img alt="" src="http://anytimecheckin.com/new/image/an-add2.jpg"></a>
				</div>
			...
			for ($i=0;$i<=$count_ad-1; $i++) {
			 ?>
				<div class="col-md-6">
					...
					if (!empty($Ad_result[$i]['banner'])) {

			$thumbimage=explode(".",$Ad_result[$i]['banner']); 
			$thumbimagefinal=$thumbimage[0]."_thumb.".$thumbimage[1];
			?>
			<a class="thumbnail" href="<?php echo $Ad_result[$i]['url'];?>"><img src="image/front/<?php echo $thumbimagefinal;?>"></a>
			<?php
		}
		else{
			?>
			<a class="thumbnail" href="<?php echo $Ad_result[$i]['url'];?>"> <img src="image/no-image.png"></a>
			<?php
		}
				///
					?>

					<!-- <a class="thumbnail" href="#"><img alt="" src="image/<?php echo $Ad_result[$i]['banner']?>"></a> -->
				</div>
			<?php }
		}else{
			for ($i=0;$i<=1; $i++) { ?>
...
<h2>Book Faster. Book Easily. Book Anytime Check In</h2>
<!--<p>The Best Oriental Hotel</p>-->
...
<div class="mail-content" align="center">
	<div class="col-sm-4 col-md-4">
		...
		<h2>MAIL US</h2>
		<p><?php echo $adminsetting['admin_email'];?></p>
		<!-- <p>info@rest&go.com</p> -->
   <!-- <p>Lorem ipsum dolor sit amet, consectetur 
      adipiscing elit, sed do eiusmod tempor incidid
      
  unt ut labore et dolore magna aliqua.</p> -->
  <a href="mailto:<?php echo $adminsetting['admin_email'];?>" target="_top"><button type="button" class="btn me bb gg">MAIL ME</button></a>
</div>
<div class="col-sm-4 col-md-4">
	<img src="image/locat.png">
	<h2>LOCATE US</h2>
	<p><?php echo $adminsetting['admin_locate'];?></p>
   <!-- <p>Lorem ipsum dolor sit amet, consectetur 
      adipiscing elit, sed do eiusmod tempor incidid
      
  unt ut labore et dolore magna aliqua.</p> -->
  <a href="contact.php"><button type="button" class="btn me yes">VIEW MAP</button>
</div></a>
<div class="col-sm-4 col-md-4">
	<img src="image/need.png">
	<h2>NEED HELP</h2>
	<p><?php echo $adminsetting['admin_phone'];?></p>
   <!-- <p>Lorem ipsum dolor sit amet, consectetur 
      adipiscing elit, sed do eiusmod tempor incidid
      
  unt ut labore et dolore magna aliqua.</p> -->
  
  <a href="skype:<?php echo $adminsetting['admin_phone'];?>"><button type="button" class="btn me">CALL US</button></a>
</div>
</div>
</div>
</div>
...
<script type="text/javascript">
  ...
  var end = new Date(date.getFullYear(), date.getMonth(), date.getDate()+1);
   ...
   //var date1 = new Date();
//   var today1 =new Date(date.getFullYear(), date.getMonth(), date.getDate()+1);
//           // console.log(today);
