           ...
           <div class="month-area ss">
             ...
             <div class="time-area ae">
               ...
               <form class="rad">
                     ...
                     <div class="col-sm-2 col-md-2 mobile-search">
                       <div class="month-area ss">
                        ...
                        <div class="time-area calen">
                         ...
                         <!--  <h2>10 March 2018</h2><p>Saturday</p> -->
                         <div class="rod">
                           <input type="text" class="form-control hasDatepicker" placeholder="Date" name="check_in_date" data-date-format="d M y" id="check_in_date" value="<?php if(!empty($check_in_date)){echo $check_in_date;}?>">
                   ...
                   <div class="col-sm-2 col-md-2 mobile-third">
                     ...
                     <a id="contact">
                       <div class="month-area ss">
                         ...
                         <div class="time-area rooms">
                           ...
                           <p ><span id="no_of_childs"><?php if(!empty($no_of_childs)){echo $no_of_childs;}else{echo '1';}?></span> Child<span class="child_s">ren</span></p>
