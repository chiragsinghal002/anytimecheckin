...
<!-- manila-area -->
    ...
    <button type="button" class="btn btn-info btn-lg pop-up" data-toggle="modal" data-target="#myModal"> more photos</button>
          ...
          <div class="tt">
            ...
            <div class="col-sm-3 col-md-3 qq">
              ...
              <div class="queen-pic">
			    ...
			    <button type="button" class="btn btn-info btn-lg pop-up" data-toggle="modal" data-target="#myModal2"> more photos</button>
        ...
        <div class="modal-body">
                <div id="myCarousel2" class="carousel slide">
                    ...
                    <div class="carousel-inner">
                        ...
                        <a class="carousel-control left pt-3" href="#myCarousel2" data-slide="prev"><i class="fa fa-chevron-left"></i></a>
                        <a class="carousel-control right pt-3" href="#myCarousel2" data-slide="next"><i class="fa fa-chevron-right"></i></a>
