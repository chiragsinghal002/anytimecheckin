    ...
    <div class="col-md-12">
      <div class="box">
        <div class="box-header with-border">
          <h3 class="box-title">Create Featured AD</h3>
          <div class="tt">
        ...
        <div class="box-body my-form-body">
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open_multipart(base_url('admin/featuredad/add'), 'class="form-horizontal needs-validation" novalidate');  ?> 
              <div class="form-group">
                <label for="ad_name validationCustom100" class="col-sm-2 control-label">AD Title</label>

                <div class="col-sm-9">
                  <input type="text" name="ad_name" class="form-control" id="ad_name validationCustom100" required placeholder="">
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="effective_From" class="form-control" id="effective_From validationCustom101" required placeholder="yyyy-mm-dd">
				  	      <div class="invalid-feedback">
              Enter Date
            </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="effective_to" class="form-control" id="effective_to validationCustom102" required placeholder="yyyy-mm-dd">
				  		  	      <div class="invalid-feedback">
              Enter Date To
            </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="url" name="url" class="form-control" id="url validationCustom102" required placeholder="URL">
				  	  		  	      <div class="invalid-feedback">
              Enter URL
            </div>
                </div>
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9 gallery">
                  <input type="file" name="banner[]" multiple="multiple" id="inputFile1 validationCustom104" required class="form-control" accept="image/*">
				  		  	  		  	      <div class="invalid-feedback">
              Enter Featured Ad
            </div>
                </div>
             ...
             <div class="form-group">
                <label for="status validationCustom105"  class="col-sm-2 control-label">Status</label>
