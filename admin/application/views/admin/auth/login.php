    ...
    <div class="container">
        <div class="row">
            ...
            <div class="col-md-4 col-md-offset-4 text-center">
				...
				<img src="https://www.anytimecheckin.com/new/image/logo-footer.png">
                    <h3><!--<span>Rest & Go</span>-->USER MANAGEMENT SYSTEM</h3>
                </div>
                ...
                <div class="form-box">
                    ...
                    <?php echo form_open(base_url('admin/auth/login'), 'class="login-form" '); ?>
                        <div class="input-group">
                            <input type="email" name="email" id="email" value="admin@gmail.com" class="form-control" placeholder="Email" >
