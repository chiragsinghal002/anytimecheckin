      ...
      ?>
              ...
              Enter Select Hotel
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="text" name="hotel_room_type" value="<?= $roomtype['hotel_room_type']; ?>" class="form-control" id="hotel_room_type validationCustom101" required placeholder="">
   	  	     <div class="invalid-feedback">
              Enter Room Type
            </div>
                </div>
              ...
              <div class="form-group">
                <label for="hotel_room_type validationCustom102" class="col-sm-2 control-label">Price</label>

                <div class="col-sm-4">
                  <input type="number" name="hours_price" value="<?php echo $roomtype['price_per_hour'];?>" class="form-control" id="hotel_room_type validationCustom101" required placeholder="hourly price">
				    <div class="invalid-feedback">
              Enter Price
            </div>
                </div>
          ...
          ?>
              ...
              Enter puneetr
               ...
               <div class="form-group validationCustom105">
                <label for="hotel_room_type" class="col-sm-2 control-label">Capacity</label>

                <div class="col-sm-4">
                  <select name="adult_person_capacity" id="validationCustom100" required class="form-control">
              ...
              <div class="form-group">
                <label for="role validationCustom106" class="col-sm-2 control-label">Status</label>

                <div class="col-sm-9">
                  <select name="status" id="validationCustom106" required class="form-control">
              ...
              Select Status
               ...
               <div class="form-group">
                <label for="hotel_facilities validationCustom110" class="col-sm-2 control-label">Description</label>
                

                <div class="col-sm-9">
                  <textarea rows="10" id="validationCustom110" required cols="10" name="description" class="text"><?php echo $roomtype['description']; ?>     </textarea>
