          ...
          <?php if(isset($msg) || validation_errors() !== ''): ?>
            ...
            <?php echo form_open_multipart(base_url('admin/hotels/addhotelphotos'), 'class="form-horizontal needs-validation" novalidate');  ?> 
              ...
              <div class="form-group">
                ...
                <div class="col-sm-9">
                  <select name="hotel_id" class="form-control" id="validationCustom100" required onchange="room_type(this.value)">
              ...
              <!-- <div class="form-group">
               ...
               <div class="form-group">
                ...
                <div class="col-sm-9">
                  <input type="file" name="hotel[]" multiple="multiple" class="form-control" id="validationCustom100" required . accept="image/*">
