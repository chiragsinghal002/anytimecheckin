...
<div class="box-header">
    ...
    <div class="box-body table-responsive">
         <form method="get" action="<?= base_url('admin/hotelfacilities/'); ?>">
            <input type="text" name="facility_name"  class="users" value="<?php if(!empty($_GET['facility_name'])){ echo $_GET['facility_name']; } ?>" placeholder="facility name" />
            <select name="status">
            ...
            <input type="submit" name="submit" value="Search" / class="user-button">
			       <a href="<?= base_url('admin/hotelfacilities/'); ?>" class="user-button">Reset</a>
         </form>
