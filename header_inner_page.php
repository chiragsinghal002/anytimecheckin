...
// $pageurl = $url2[0];
// $pageurl2 = ucwords($pageurl);
$id = $_GET['id'];

$page=$user->GetPagesbyid($id);
...
if(isset($_POST['submit'])){
  ...
  $check_in_date=date('d M yy');
  $check_out_date=date('d M yy', strtotime($check_in_date . ' +1 day'));
  $optradio='1';
  $no_of_adults='1';
  $no_of_rooms='1';
  $no_of_childs='1';
  ...
  FB.api('/me' ,{fields: 'first_name,last_name,email'}, function(response) {
    ...
    var email=$("#userEmail").val(response.email);
      ...
      $.ajax({
       ...
       // alert(data);
       if(data=='0'){
         document.location.href = "anytimecheckin/user-profile.php";
       }
       else{
        document.location.href = "anytimecheckin/user-profile.php";
                ...
                <div class="row" align="center">
                   <div class="text">
                      <p align="center">
                        ...
                        if (!empty($id)) {
                         ?>
                           <span><?php echo $page['page_title'];?></span> 
